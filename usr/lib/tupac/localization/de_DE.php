...
$messageset=array(
	...
	,'aurPackageInfoListInstalled'			=>'%c %z%r/'.INSTALLEDLIGHT.'%p'.VERSIONLIGHT.' %v'.SAFELIGHT.' (%x)%s '.INSTALLMATCHLIGHT.'- This is the installed version'.NORMAL."\n".'    %d'."\n"
	,'aurPackageInfoListOtherInstalled'	=>'%c %z%r/'.INSTALLEDLIGHT.'%p'.VERSIONLIGHT.' %v'.SAFELIGHT.' (%x)%s '.NORMAL.INSTALLNOTMATCHLIGHT.'- Another version installed: %i'.NORMAL."\n".'    %d'."\n"
	,'aurPackageInfoListNotInstalled'		=>'%c %z%r/'.HIGHLIGHT.'%p'.VERSIONLIGHT.' %v'.SAFELIGHT.' (%x)%s'.NORMAL."\n".'    %d'."\n"
